...
<form action= "<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" >
  ...
  <?php
    ...
    <td hidden id="userId"><?php  echo $value['user_id']; ?></td> 
    ...
    <td>
        ...
        // $_SESSION["issuedUser"]=$value['user_id'];
        ?>
...
<script>
          ...
          element.addEventListener("change", function() {
            ...
            let problemId = "<?php echo $value['problem_id']; ?>";
            ...
            $.ajax({
                url: `update-problem-status.php?updateto=${updateTo}&id=<?php echo $problem_id; ?>`
              });

            $.ajax({
              url: `generate-notif.php?id=<?php echo $user_id; ?>&type=${updateTo}`
            });
          });
        </script>
</html>